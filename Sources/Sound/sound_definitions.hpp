...
enum /* sound chances */
{
    _ten_percent     = 32'768 * 9 / 10,
    _twenty_percent  = 32'768 * 8 / 10,
    _thirty_percent  = 32'768 * 7 / 10,
    _fourty_percent  = 32'768 * 6 / 10,
    _fifty_percent   = 32'768 * 5 / 10,
    _sixty_percent   = 32'768 * 4 / 10,
    _seventy_percent = 32'768 * 3 / 10,
    _eighty_percent  = 32'768 * 2 / 10,
    _ninty_percent   = 32'768 * 1 / 10,
    _always          = 0
};
