...
/*
 *  This contains implementations of functions for handling the OpenGL
 *  substitute textures for the walls and the sprites
 */
...
void TODelete(short Collection) { Collections[Collection].clear(); }
...
int OGL_CountTextures(short Collection) { return Collections[Collection].size(); }
...
void reset_mml_opengl_texture() { TODelete_All(); }
