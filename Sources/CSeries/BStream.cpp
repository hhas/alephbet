...
std::streampos BIStream::tellg() const { return rdbuf()->pubseekoff(0, std::ios_base::cur, std::ios_base::in); }
...
BIStream& BIStream::operator>>(uint8& value) { return read(reinterpret_cast<char*>(&value), 1); }
...
std::streampos BOStream::tellp() const { return rdbuf()->pubseekoff(0, std::ios_base::cur, std::ios_base::out); }
...
BOStream& BOStream::operator<<(uint8 value) { return write(reinterpret_cast<char*>(&value), 1); }

BOStream& BOStream::operator<<(int8 value) { return operator<<(static_cast<uint8>(value)); }
...
BOStream& BOStreamBE::operator<<(int16 value) { return operator<<(static_cast<uint16>(value)); }
...
BOStream& BOStreamBE::operator<<(int32 value) { return operator<<(static_cast<uint32>(value)); }
