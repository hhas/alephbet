...
TextLayoutHelper::~TextLayoutHelper() { removeAllReservations(); }

void TextLayoutHelper::removeAllReservations() {
...
int TextLayoutHelper::reserveSpaceFor(int inLeft, unsigned int inWidth, int inLowestBottom, unsigned int inHeight) {
