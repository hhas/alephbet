...
AOStream& AOStream::operator<<(int8 value) { return operator<<(uint8(value)); }

AOStream& AOStream::operator<<(bool value) { return operator<<(uint8(value ? 1 : 0)); }
...
AOStream& AOStreamBE::operator<<(int16 value) { return operator<<(uint16(value)); }
...
AOStream& AOStreamBE::operator<<(int32 value) { return operator<<(uint32(value)); }
...
AOStream& AOStreamLE::operator<<(int16 value) { return operator<<(uint16(value)); }
...
AOStream& AOStreamLE::operator<<(int32 value) { return operator<<(uint32(value)); }
...
AStream::failure::failure(const std::string& str) noexcept { _M_name = strdup(str.c_str()); }
...
const char* AStream::failure::what() const noexcept { return _M_name; }
