...
#include "lua_mnemonics.hpp" // for lang_def and mnemonics
...
class L_Class {
  public:
    ...
    static void Register(lua_State* L, const luaL_Reg get[] = 0, const luaL_Reg set[] = 0,
                         const luaL_Reg metatable[] = 0);
    ...
    struct ValidRange {
        ...
        bool operator()(int32 index) { return (index >= 0 && index < m_max); }
  ...
  protected:
    ...
    // registry keys
    static void _push_get_methods_key(lua_State* L) { lua_pushlightuserdata(L, (void*)(&name[1])); }

    static void _push_set_methods_key(lua_State* L) { lua_pushlightuserdata(L, (void*)(&name[2])); }

    static void _push_instances_key(lua_State* L) { lua_pushlightuserdata(L, (void*)(&name[3])); }
...
template <char* name, typename index_t>
void L_Class<name, index_t>::Register(lua_State* L, const luaL_Reg get[], const luaL_Reg set[],
...
class L_Enum : public L_Class<name, index_t> {
  public:
    ...
    static void Register(lua_State* L, const luaL_Reg get[] = 0, const luaL_Reg set[] = 0,
                         const luaL_Reg metatable[] = 0, const lang_def mnemonics[] = 0);
  ...
  private:
    ...
    static void _push_mnemonic_key(lua_State* L) { lua_pushlightuserdata(L, (void*)(&name[4])); }
};
  ...
  public:
    ...
    static index_t ToIndex(lua_State* L, int index) {
        ...
        if (lua_isnil(L, index))
            return -1;
        else if (L_Enum<name, index_t>::_lookup(L, index, to))
            return to;
        else {
            std::string error;
...
template <char* name, typename index_t>
void L_Enum<name, index_t>::Register(lua_State* L, const luaL_Reg get[], const luaL_Reg set[],
                                     const luaL_Reg metatable[], const lang_def mnemonics[]) {
...
template <char* name, class T>
void L_Container<name, T>::Register(lua_State* L, const luaL_Reg get[], const luaL_Reg set[],
                                    const luaL_Reg metatable[]) {
...
class L_ObjectClass : public L_Class<name, index_t> {
  public:
    ...
    static index_t Index(lua_State* L, int index) { return L_Class<name, index_t>::Index(L, index); }

    static bool Is(lua_State* L, int index) { return L_Class<name, index_t>::Is(L, index); }
