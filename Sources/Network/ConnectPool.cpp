...
NonblockingConnect::NonblockingConnect(const IPaddress& ip) : m_ip(ip), m_ipSpecified(true) { connect(); }
...
ConnectPool::ConnectPool() {
    for (int i = 0; i < kPoolSize; i++) { m_pool[i] = std::pair<NonblockingConnect*, bool>(0, true); }
}
