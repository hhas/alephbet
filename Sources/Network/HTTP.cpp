...
void HTTPClient::Init() { curl_global_init(CURL_GLOBAL_ALL); }
...
#if LIBCURL_VERSION_NUM >= 0x07'1504
...
bool HTTPClient::Post(const std::string&, const std::map<std::string, std::string>&) { return false; }
