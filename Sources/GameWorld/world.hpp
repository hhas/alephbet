...
struct long_vector2d {
    ...
    constexpr auto& operator+=(long_vector2d b) {
        i += b.i;
        j += b.j;
        return *this;
    }
    ...
    constexpr auto& operator*=(S s) {
        return (*this = {int32(s * i), int32(s * j)});
    }
};
...
struct long_vector3d {
    ...
    constexpr auto& operator+=(long_vector3d b) {
        i += b.i;
        j += b.j;
        k += b.k;
        return *this;
    ...
    template <class S>
    constexpr auto& operator*=(S s) {
        return (*this = {int32(s * i), int32(s * j), int32(s * k)});
    }
...
struct long_point2d {
    ...
    constexpr auto& operator+=(long_vector2d v) {
        x += v.i;
        y += v.j;
        return *this;
    }
...
struct long_point3d {
    ...
    constexpr auto& operator+=(long_vector3d v) {
        x += v.i;
        y += v.j;
        z += v.k;
        return *this;
...
template <class S>
constexpr auto operator*(S s, long_vector2d v) {
    return v *= s;
}

template <class S>
constexpr auto operator*(S s, long_vector3d v) {
    return v *= s;
}
...
struct fixed_yaw_pitch {
    fixed_angle yaw, pitch;
};
...
struct world_location3d {
    ...
    bool operator==(const world_location3d& other) const {
        return std::tie(pitch, yaw, polygon_index, point, velocity)
               == std::tie(other.pitch, other.yaw, other.polygon_index, other.point, other.velocity);
    }

    bool operator!=(const world_location3d& other) const { return !(*(this) == other); }
};
...
static inline angle normalize_angle(angle theta) { return NORMALIZE_ANGLE(theta); }
