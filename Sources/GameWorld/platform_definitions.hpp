...
struct platform_definition platform_definitions[NUMBER_OF_PLATFORM_TYPES] = {
        {
         ...
         _ambient_snd_spht_door,           NONE, /* key item index */
...

        {
         ...
         _ambient_snd_spht_platform,       NONE, /* key item index */
        ...
        {// _platform_is_heavy_spht_door
         ...
         _ambient_snd_heavy_spht_door,     NONE, /* key item index */
...

        {
         ...
         _ambient_snd_pfhor_door,          NONE, /* key item index */
        ...
        {// _platform_is_heavy_spht_platform
         ...
         _ambient_snd_heavy_spht_platform, NONE, /* key item index */

         {
                 /* defaults */
                 _platform_is_heavy_spht_platform,
                 _slow_platform,
                 _long_delay_platform,
                 NONE,
                 NONE,
                 FLAG(_platform_is_initially_active) | FLAG(_platform_is_initially_extended)
                         | FLAG(_platform_comes_from_floor) | FLAG(_platform_reverses_direction_when_obstructed),
...

        {
         ...
         _ambient_snd_pfhor_platform,      NONE, /* key item index */
