...
static int16 weapon_ordering_array[]
        = {_weapon_fist, _weapon_pistol, _weapon_plasma_pistol, _weapon_shotgun, _weapon_assault_rifle,
           // LP addition:
           _weapon_smg, _weapon_flamethrower, _weapon_missile_launcher, _weapon_alien_shotgun, _weapon_ball};
...
const struct weapon_definition original_weapon_definitions[NUMBER_OF_WEAPONS] = {
        ...
        {/* item type, powerup type, item class, item flags */
         _i_knife,            NONE,
         _melee_class,            _weapon_fires_under_media,

         FIXED_ONE_HALF,    0,                    /* firing intensity, firing decay */

         /* idle height, bob amplitude, kick height, reload height */
         FIXED_ONE + FIXED_ONE / 15,
         FIXED_ONE / 15,
         FIXED_ONE / 16,
         0,                 /* horizontal positioning.. */
         FIXED_ONE_HALF,               0,

         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _fist_idle,
         _fist_punching,           _fist_idle,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND / 4,
         0,                                                                         0,
         0,                                                                                              0,
        ...
        {/* item type, powerup type, item class, item flags */
         _i_magnum,           NONE,
         _twofisted_pistol_class, _weapon_fires_out_of_phase,

         3 * FIXED_ONE / 4,
         TICKS_PER_SECOND / 8,                    /* firing intensity, firing decay */

         /* idle height, bob amplitude, kick height, reload height */
         FIXED_ONE + FIXED_ONE / 15,
         FIXED_ONE / 25,
         FIXED_ONE / 8,
         FIXED_ONE,         /* horizontal positioning.. */
         FIXED_ONE_HALF,       0,

         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _pistol_idle,
        ...
        /* Fusion Pistol */
        {/* item type, powerup type, item class, item flags */
         _i_plasma_pistol,    NONE,
         _dual_function_class,    _weapon_overloads | _weapon_fires_under_media | _weapon_triggers_share_ammo,

         3 * FIXED_ONE / 4,
         TICKS_PER_SECOND / 3,                    /* firing intensity, firing decay */

         /* idle height, bob amplitude, kick height, reload height */
         FIXED_ONE,                              FIXED_ONE / 25,
         FIXED_ONE / 8,
         FIXED_ONE,         /* horizontal positioning.. */
         FIXED_ONE_HALF,       0,

         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _fusion_idle,
         _fusion_firing,           NONE,
         NONE, NONE,
         _fusion_charged, /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND / 3,
         TICKS_PER_SECOND / 2,
         TICKS_PER_SECOND / 2,
         TICKS_PER_SECOND / 2,
         0,                                                                                                 {{/* rounds per magazine */
           20,
        ...
        /* Assault Rifle */
        {/* item type, powerup type, item class, item flags */
         _i_assault_rifle,    NONE,
         _multipurpose_class,     _weapon_is_automatic,

         3 * FIXED_ONE / 4,
         TICKS_PER_SECOND / 5,                    /* firing intensity, firing decay */


         /* idle height, bob amplitude, kick height, reload height */
         FIXED_ONE + FIXED_ONE / 6,
         FIXED_ONE / 35,
         FIXED_ONE / 16,
         3 * FIXED_ONE / 4,
         ...
         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _assault_rifle_idle,
         ...
         0,                                                                                                 {{/* rounds per magazine */
           ...
           /* firing, click, charging, shell casing, reload sound */
           _snd_assault_rifle_firing, _snd_empty_gun, NONE, _snd_assault_rifle_shell_casings,
           _snd_assault_rifle_reloading, NONE,
        ...
        {/* item type, powerup_type, item class, item flags */
         _i_missile_launcher, NONE,
         _normal_class,           _no_flags,
         ...
         FIXED_ONE,         /* horizontal positioning.. */
         (FIXED_ONE_HALF / 4),
         0,                                          /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection, _missile_launcher_idle,
         _missile_launcher_firing, NONE,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
        ...
        /* flamethrower */
        {/* item type, powerup type, item class, item flags */
         _i_flamethrower,     NONE,
         _normal_class,           _weapon_is_automatic,

         3 * FIXED_ONE / 4,
         TICKS_PER_SECOND / 3,                    /* firing intensity, firing decay */

         /* idle height, bob amplitude, kick height, reload height */
         FIXED_ONE,                              FIXED_ONE / 35,
         FIXED_ONE / 15,
         FIXED_ONE / 2,
         ...
         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _flamethrower_idle,
         _flamethrower_firing,     NONE,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND,                (2 * TICKS_PER_SECOND) / 3,
         (2 * TICKS_PER_SECOND) / 3,
         (2 * TICKS_PER_SECOND) / 3,
         0,                                                                                                 {{/* rounds per magazine */
           7 * TICKS_PER_SECOND,
        ...
        /* alien weapon */
        {/* item type, powerup type, item class, item flags */
         _i_alien_shotgun,    NONE,
         _multipurpose_class,     _weapon_is_automatic | _weapon_disappears_after_use | _weapon_has_random_ammo_on_pickup
         ...
         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _alien_weapon_idle,
         _alien_weapon_firing,     NONE,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND / 2,
         TICKS_PER_SECOND / 3,
...
#define SHOTGUN_SPREAD      5
        ...
        {/* item type, powerup type, item class, item flags */
         _i_shotgun,          NONE,
         _twofisted_pistol_class, _weapon_reloads_in_one_hand,
         ...
         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _shotgun_idle,
         _shotgun_firing,          _shotgun_reloading,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND / 3,
         5,                                                                         5,
        ...
        {/* item type, powerup type, item class, item flags */
         _i_smg,              NONE,
         _normal_class,           _weapon_is_automatic | _weapon_fires_under_media,
         ...
         /* collection, idle, firing, reloading shapes; shell casing, charging, charged */
         _weapon_in_hand_collection,            _smg_idle,
         _smg_firing,              _smg_reloading,
         NONE, NONE,
         NONE,            /* ready/await/load/finish/powerup rounds ticks */
         TICKS_PER_SECOND / 2,
         TICKS_PER_SECOND / 3,
